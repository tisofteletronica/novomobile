  ...
  theme: {
    extend: {
      backgroundImage: {
        ...
        "orange-gradient":
          "linear-gradient(90deg, rgba(255,255,255,1) 50%, rgba(252,76,2,1) 50%)",
        "home-gradiente-about":
          "linear-gradient(90deg, rgba(223,223,231,1) 50%, rgba(255,255,255,1) 50%)",
        "home-gradiente-structure":
          "linear-gradient(90deg, #484848 50%, transparent 50%)",
